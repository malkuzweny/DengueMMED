...
cl.perarm.d_3st <- run.sscalc(z_a2=1.96, z_b=0.84, pi_0=case_c_2yr, treatment_effect = 0.3, k=0.15, clusters_perarm = 15)
...
cl.perarm.d_3to4st <- run.sscalc(z_a2=1.96, z_b=0.84, pi_0=case_c_2yr, treatment_effect = 0.3, k=0.15, clusters_perarm = 15)
...
cl.perarm.d_4st <- run.sscalc(z_a2=1.96, z_b=0.84, pi_0=case_c_2yr, treatment_effect = 0.3, k=0.15, clusters_perarm = 15)
...
cl_df$second_perc <- cl_df$second/cl_df$first
cl_df$third_perc <- cl_df$third/cl_df$first
